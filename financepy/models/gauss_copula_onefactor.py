...
def loss_dbn_recursion_gcd(num_credits,
    ...
    for iCredit in range(int(num_credits)):
    ...
    for iLossUnit in range(int(numLossUnits)):
...
def homog_basket_loss_dbn(survival_probabilities,
    ...
    return loss_dbn_recursion_gcd(num_credits,
                                     default_probs,
                                     lossUnits,
                                     beta_vector,
                                     num_integration_steps)
